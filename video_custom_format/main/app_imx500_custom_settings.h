...
static const esp_cam_sensor_format_t custom_format_info = {
    ...
    .width = 2028,                                                            // 图像宽度
    .height = 1520,                                                           // 图像高度
    .regs = imx500_input_MIPI_2lane_2028x1520_regs,                  // 寄存器配置数组
    .regs_size = ARRAY_SIZE(imx500_input_MIPI_2lane_2028x1520_regs), // 寄存器配置数组大小
    .fps = 56,                                                               // 帧率
    .isp_info = &imx500_fmt_isp_info,                                        // ISP信息指针
    .mipi_info = {
