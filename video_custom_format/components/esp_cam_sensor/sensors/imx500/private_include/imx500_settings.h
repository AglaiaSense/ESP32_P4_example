...
#define IMX500_8BIT_MODE                           (0x18)
#define IMX500_10BIT_MODE                          (0x1A)
#define IMX500_MIPI_CTRL00_CLOCK_LANE_GATE         BIT(5)
#define IMX500_MIPI_CTRL00_LINE_SYNC_ENABLE        BIT(4)
#define IMX500_MIPI_CTRL00_BUS_IDLE                BIT(2)
#define IMX500_MIPI_CTRL00_CLOCK_LANE_DISABLE      BIT(0)

static const imx500_reginfo_t imx500_mipi_reset_regs[] = {
    {0x0100, 0x00}, // enable sleep
    {0x0103, 0x01},
    {IMX500_REG_DELAY, 0x0a},
...
static const imx500_reginfo_t imx500_input_24M_MIPI_2lane_raw8_800x640_50fps[] = {
    ...
    {0x3036, ((IMX500_IDI_CLOCK_RATE_800x640_50FPS * 8 * 4) / 25000000)},
    {0x303c, 0x11},
    {0x3106, 0xf5},
    {0x3821, 0x03},
    {0x3820, 0x41},
    ...
    {0x4004, 0x02},
    {0x4000, 0x09},
    {0x4837, (1000000000 / (IMX500_IDI_CLOCK_RATE_800x640_50FPS / 4))},
    {0x4050, 0x6e},
    {0x4051, 0x8f},
    {IMX500_REG_END, 0x00},
};
...
static const imx500_reginfo_t imx500_input_24M_MIPI_2lane_raw8_800x1280_50fps[] = {
    {0x3034, 0x18},
    {0x3035, 0x41},
    {0x3036, ((IMX500_IDI_CLOCK_RATE_800x1280_50FPS * 8 * 4) / 25000000)},
    {0x303c, 0x11},
    {0x3106, 0xf5},
...
// auto AGC mode configuration aec gain
    ...
    {0x4001, 0x02},
    {0x4004, 0x04},
    {0x4837, (1000000000 / (IMX500_IDI_CLOCK_RATE_800x1280_50FPS / 4))},
    {0x4050, 0x6e},
    {0x4051, 0x8f},
    {0x5903, 0xff},
    {IMX500_REG_END, 0x00},
