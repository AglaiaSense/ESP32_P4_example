...
static esp_err_t init_codec_h264_video(image_sd_card_t *sd)
{
    int fd;
...
static esp_err_t init_codec_mjpeg_video(image_sd_card_t *sd)
{
    int fd;
...
static esp_err_t store_avi_to_sd_card(image_sd_card_t *sd)
{
    printf("store_avi_to_sd_card\n");
    ...
    ESP_ERROR_CHECK(init_codec_h264_video(sd));
...
static esp_err_t store_jpg_to_sd_card(image_sd_card_t *sd)
{
    ...
    ESP_ERROR_CHECK(init_codec_mjpeg_video(sd));
...
void app_main(void)
{
    ...
    ESP_ERROR_CHECK(store_avi_to_sd_card(sdc));
    ESP_ERROR_CHECK(store_jpg_to_sd_card(sdc));
